package com.dio.womensfootballnews.ui.adapter;
...
import com.dio.womensfootballnews.databinding.NewsItemBinding;
...
public class NewsAdapter extends RecyclerView.Adapter<NewsAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
       ...
       //Implementation of functionality "Open Link"
        ...
        //Implementation of functionality "Share"
        ...
        //Implementation of functionality "Favorite"
        holder.binding.ivFavorites.setOnClickListener( view -> {
            news.favorite = !news.favorite;
            this.favoriteListener.onFavorite(news);
            notifyItemChanged(position);
        });
        int favoriteColor = news.favorite ? R.color.green_500 : R.color.black;
